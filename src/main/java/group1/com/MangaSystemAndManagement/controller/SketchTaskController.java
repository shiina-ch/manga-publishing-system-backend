...
@RestController
@RequestMapping("/api/sketch-tasks")
@Tag(name = "SketchTask", description = "Sketch task management APIs")
@RequiredArgsConstructor
public class SketchTaskController {
    ...
    public ResponseEntity<ResponseBase> findAll() {
        try {
            List<SketchTask> result = service.findAll();
