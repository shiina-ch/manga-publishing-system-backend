...
@RestController
@RequestMapping("/api/sketch-reviews")
@Tag(name = "SketchReview", description = "Sketch review management APIs")
@RequiredArgsConstructor
public class SketchReviewController {
    ...
    public ResponseEntity<ResponseBase> findAll() {
        try {
            List<SketchReview> result = service.findAll();
