...
public class SubmissionReviewController {
    ...
    @PostMapping
    public ResponseEntity<ResponseBase> create(@RequestBody SubmissionReview entity) {
        try {
            SubmissionReview result = service.create(entity);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseBase> update(@PathVariable Long id, @RequestBody SubmissionReview entity) {
        try {
            SubmissionReview result = service.update(id, entity);
